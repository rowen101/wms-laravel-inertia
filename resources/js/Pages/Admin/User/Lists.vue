...
<AuthenticatedLayout>
  ...
  <SectionTitleLineWithButton :icon="mdiAccountGroup" title="User Profile" main>
  ...
  <PopupDialog :open="showPop" popupTitle="Delete Confirmation" okButtonText="Yes, Delete" cancelButtonText="Cancel"
    ...
    <p class="text-sm text-gray-500">{{ 'Are you sure you want to delete this record ' + (formdata.code + ', ' +
